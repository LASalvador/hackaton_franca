...
export default {
  data () {
    return {
      dailySalesChart: {
        data: {
          labels: ['Zona Sul', 'Zona Oeste', 'Zona Leste', 'Zona Norte', 'Centro', 'Zona Rural'],
          series: [
            [850, 700, 450, 620, 800, 300]
          ]
        },
        options: {
      ...
      dataCompletedTasksChart: {
        data: {
          ...
          series: [
            [230, 750, 450, 300, 280, 240, 200, 190,120,150,180,100]
          ]
        },
        options: {
          lineSmooth: this.$chartist.Interpolation.cardinal({
      ...
      idade: {
        data: {
          labels: ['18-30 anos', '31-40 anos', '41-50 anos', '51-60 anos', '61-70 anos', '71-80 anos', '81-90 anos', '91+ anos'],
          series: [
            [700, 856, 780, 558, 750, 478, 155, 10]
          ]
        },
        options: {
          axisX: {
